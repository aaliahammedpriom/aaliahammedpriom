...
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|---------------------------------------------|----------------------------------------------------------|
| [MERN Forum Project] | [GitHub](https://github.com/aaliahammedpriom/mern-forum-client) | [GitHub](https://github.com/aaliahammedpriom/mern-forum-server) | [Live](https://mern-forum-project.herokuapp.com/) | User authentication, Post interactions, Admin controls, Role-based access | Enhanced comment reporting, Real-time notifications, Advanced analytics |
